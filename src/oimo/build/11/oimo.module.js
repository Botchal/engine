...
exports.InfoDisplay = exports.printError = exports.AABB_PROX = exports.JOINT_PRISMATIC = exports.JOINT_SLIDER = exports.JOINT_WHEEL = exports.JOINT_HINGE = exports.JOINT_BALL_AND_SOCKET = exports.JOINT_DISTANCE = exports.JOINT_NULL = exports.SHAPE_TETRA = exports.SHAPE_PARTICLE = exports.SHAPE_PLANE = exports.SHAPE_CYLINDER = exports.SHAPE_BOX = exports.SHAPE_SPHERE = exports.SHAPE_NULL = exports.BODY_GHOST = exports.BODY_KINEMATIC = exports.BODY_STATIC = exports.BODY_DYNAMIC = exports.BODY_NULL = exports.BR_BOUNDING_VOLUME_TREE = exports.BR_SWEEP_AND_PRUNE = exports.BR_BRUTE_FORCE = exports.BR_NULL = exports.REVISION = exports.World = exports.RigidBody = exports.JointConfig = exports.WheelJoint = exports.SliderJoint = exports.PrismaticJoint = exports.DistanceJoint = exports.BallAndSocketJoint = exports.HingeJoint = exports.LimitMotor = exports.ShapeConfig = exports.Particle = exports.Plane = exports.Cylinder = exports.Sphere = exports.Box = exports.Shape = exports.Mat33 = exports.Quat = exports.Vec3 = exports.Math = void 0;
...
Object.assign(Quat.prototype, {
    ...
    setFromUnitVectors: function (v1, v2) {
        ...
        if (r < _Math.EPS2) {
            r = 0;
            if (_Math.abs(v1.x) > _Math.abs(v1.z))
                vx.set(-v1.y, v1.x, 0);
            else
                vx.set(0, -v1.z, v1.y);
        }
...
Object.assign(Rotational3Constraint.prototype, {
    ...
    preSolve: function (timeStep, invTimeStep) {
        ...
        if (enableLimit3) {
            ...
            if (!enableSpring3) {
                if (this.limitVelocity3 > 0.02)
                    this.limitVelocity3 -= 0.02;
                else if (this.limitVelocity3 < -0.02)
                    this.limitVelocity3 += 0.02;
                else
                    this.limitVelocity3 = 0;
            }
        ...
        this.k11 += this.cfm2;
        this.k22 += this.cfm3;
        var inv = 1 / (this.k00 * (this.k11 * this.k22 - this.k21 * this.k12) +
...
HingeJoint.prototype = Object.assign(Object.create(Joint.prototype), {
    ...
    preSolve: function (timeStep, invTimeStep) {
        ...
        if (_Math.dotVectors(this.nor, this.tmp) < 0)
...
Object.assign(Translational3Constraint.prototype, {
    ...
    preSolve: function (timeStep, invTimeStep) {
        ...
        if (enableLimit1) {
            ...
            if (!enableSpring1) {
                if (this.limitVelocity1 > 0.005)
                    this.limitVelocity1 -= 0.005;
                else if (this.limitVelocity1 < -0.005)
                    this.limitVelocity1 += 0.005;
                else
                    this.limitVelocity1 = 0;
            }
        ...
        if (enableLimit2) {
            ...
            if (!enableSpring2) {
                if (this.limitVelocity2 > 0.005)
                    this.limitVelocity2 -= 0.005;
                else if (this.limitVelocity2 < -0.005)
                    this.limitVelocity2 += 0.005;
                else
                    this.limitVelocity2 = 0;
            }
        ...
        if (enableLimit3) {
            ...
            if (!enableSpring3) {
                if (this.limitVelocity3 > 0.005)
                    this.limitVelocity3 -= 0.005;
                else if (this.limitVelocity3 < -0.005)
                    this.limitVelocity3 += 0.005;
                else
                    this.limitVelocity3 = 0;
            }
        ...
        if (this.weight >= 0)
            w1 = this.weight; // use given weight
        var w2 = 1 - w1;
        this.r1x = this.r1.x + rdx * w1;
        this.r1y = this.r1.y + rdy * w1;
        this.r1z = this.r1.z + rdz * w1;
...
SliderJoint.prototype = Object.assign(Object.create(Joint.prototype), {
    ...
    preSolve: function (timeStep, invTimeStep) {
        ...
        var limite = _Math.acosClamp(_Math.dotVectors(this.an1, this.an2));
        if (_Math.dotVectors(this.nor, this.tmp) < 0)
            this.rotationalLimitMotor.angle = -limite;
        else
            this.rotationalLimitMotor.angle = limite;
        // angular error
        this.tmp.crossVectors(this.ax1, this.ax2);
...
function World(o) {
    ...
    if (this.isStat)
        this.performance = new InfoDisplay(this);
    /**
    ...
    */
    ...
    initBody: function (type, o) {
        ...
        for (var i = 0; i < type.length; i++) {
            ...
            if (r2[n] !== undefined)
                sc.relativeRotation.setQuat(new Quat().setFromEuler(r2[n], r2[n + 1], r2[n + 2]));
            switch (type[i]) {
                case "sphere":
    ...
    initJoint: function (type, o) {
        ...
        switch (type) {
            ...
            case "joint":
                ...
                if (spring !== null)
                    joint.limitMotor.setSpring(spring[0], spring[1]); // soften the joint ex: 100, 0.2
                if (motor !== null)
                    joint.limitMotor.setMotor(motor[0], motor[1]);
                break;
            case "jointPrisme":
            ...
            case "jointWheel":
                ...
                if (motor !== null)
                    joint.rotationalLimitMotor1.setMotor(motor[0], motor[1]);
                break;
        }
        joint.name = o.name || '';
        // finaly add to physics world
